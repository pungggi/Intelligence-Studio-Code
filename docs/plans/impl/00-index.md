...
| [phase-6-marketplace.md](phase-6-marketplace.md) | Marketplace & Discovery | Phase 5 | **Complete** (2026-08-25) — registry server, `.ccext` install, Native badge, ed25519 signatures; deployment + UI tab backlog |
